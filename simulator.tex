...
\item For the Soft Hand, the hand is closed maximally, for the Reflex Hand, a force threshold technique equivalent to the one performed on the physical hardware is used \todo{also on paper fix: explain which technique was used} to arrest the hand closure (the object will move accordingly),
